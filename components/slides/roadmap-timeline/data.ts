...
import type { Track, Timeline2026Track } from "./types";

export const timeline2026Eyebrow = "2026 Timeline (Single Phase Plan)";
export const timeline2026Months = ["May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
export const timeline2026Year = "2026";

export const timeline2026Tracks: Timeline2026Track[] = [
  {
    number: 1,
    icon: Database,
    title: "Master Data & Infrastructure",
    description: "Database, ORM, User Auth, Master Data",
    status: "completed",
    startMonth: 0,
    span: 2,
    statusLabel: "Completed",
    detailStatus: "Operational",
    modulesTotalLabel: "10 Modules",
    modules: [
      "Company Master",
      "Brand Master",
      "Line of Business (LOB) Master",
      "Division Master",
      "Bank Master",
      "User Management",
  ...
  },
  {
    number: 2,
    icon: Building2,
    title: "General Affairs (13 Modules)",
    description: "Asset, Fleet, Maintenance, Permit, Vendor, Cost, GA Expense & more",
    status: "completed",
    startMonth: 0,
    span: 3,
    statusLabel: "Operational",
    detailStatus: "Operational",
    modulesTotalLabel: "13 Modules",
    modules: [
      "Fixed Asset Management",
      "QR Code & Barcode Asset Tagging",
      "Stock Opname Management",
      "Vehicle & Fleet Management",
      "Maintenance Scheduler",
      "Device Rental Management",
      "IT Hardware Rental Management",
      "Insurance Policy Tracking",
      "Permit & License Tracking",
      "Vendor Directory",
      "Vendor Performance Scorecard",
      "GA Expense Tracking",
      "GA Budget Monitoring",
    ],
  },
  {
    number: 3,
    icon: Scale,
    title: "Legal & Compliance (8 Modules)",
    description: "Contract, Litigation, SOP Audit, Compliance, License & more",
    status: "validation",
    startMonth: 0,
    span: 7,
    segments: [
      { label: "Build (May – Jul)", weight: 3 },
      { label: "Validation (Aug – Sep)", weight: 2 },
      { label: "Enhancement (Oct – Nov)", weight: 1.5 },
      { label: "Stabilization & Adoption (Nov)", weight: 0.5 },
    ],
    statusLabel: "Continuous Validation & Enhancement",
    detailStatus: "Business Validation",
    modulesTotalLabel: "8 Modules",
    modules: [
      "Corporate Legal Document Repository",
      ...
      "Email Approval Workflow (Magic Link)",
    ],
  },
  {
    number: 4,
    icon: Megaphone,
    title: "Marketing Budget (11 Modules)",
    description: "Campaign, Budget, Approval, Payment, Timeline & more",
    status: "validation",
    startMonth: 1,
    span: 6,
    segments: [
      { label: "Pilot Implementation (Late Jun – Jul)", weight: 1.5 },
      { label: "Validation (Aug – Sep)", weight: 2 },
      { label: "Enhancement (Oct – Nov)", weight: 1.5 },
      { label: "Business Adoption (Nov)", weight: 1 },
    ],
    statusLabel: "Continuous Validation & Enhancement",
    detailStatus: "Pilot & Validation",
    modulesTotalLabel: "11 Modules",
    modules: [
      "Campaign Dashboard",
      "Campaign Planning",
      "Campaign Management",
  ...
  },
  {
    ...
    description: "Proxmox, Nginx, SSL, PM2, CORS, Deploy Script",
    status: "completed",
    startMonth: 2,
    span: 2,
    statusLabel: "Ready",
    detailStatus: "Operational",
    modulesTotalLabel: "7 Components",
    modules: [
      "Proxmox Deployment",
      "Ubuntu LXC Environment",
      "Nginx Reverse Proxy",
      "SSL Security",
      "PM2 Process Manager",
  ...
  },
  {
    ...
    description: "Security, Notifications, RBAC, Dashboard, Export, Mobile",
    status: "planned",
    startMonth: 3,
    span: 3,
    statusLabel: "Planned",
  },
  {
    number: 7,
    icon: UsersRound,
    title: "UAT & Data Migration",
    description: "UAT, Data Migration, Bug Fixes, Performance Optimization",
    status: "planned",
    startMonth: 4,
    span: 3,
    statusLabel: "Planned",
  },
  {
    number: 8,
    icon: GraduationCap,
    title: "Organization Adoption & Training",
    description: "User Training, Documentation, Change Management",
    status: "planned",
    startMonth: 4,
    span: 3,
    statusLabel: "Planned",
  },
  {
    number: 9,
    icon: Rocket,
    title: "Enterprise Go-Live",
    description: "Production Rollout, Hypercare, Support & Iteration",
    status: "golive",
    startMonth: 7,
    span: 1,
    statusLabel: "Go-Live",
    statusSubLabel: "Dec 2026",
  },
];
...
export const inHouseData: TimelineData = {
  ...
  subtitle: "GA, Legal & Compliance running since May; Marketing Budget module initiated in late June — full go-live in December.",
  ...
  legend: [
    ...
    { variant: "milestone", label: "Go-Live Milestone · December 2026" },
  ],
};
